...
#define xorstr_arr(str) ::jm::xor_string([]() { return str.data(); }, std::integral_constant<std::size_t, str.size()>{}, std::make_index_sequence<::jm::detail::_buffer_size<sizeof(str)>()>{})
#define xorstr_arr_(str) xorstr_arr(str).crypt_get()
...
namespace jm {
    ...
    public:
        ...
        XORSTR_FORCEINLINE void crypt() noexcept
        {
            ...
            auto* keys = (std::uint64_t*)::jm::detail::load_from_reg((std::uint64_t)arr);
